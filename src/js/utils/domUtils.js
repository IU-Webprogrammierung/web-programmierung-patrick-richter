/**
 * @module domUtils
 * @description Hilfsfunktionen für DOM-Manipulation und -Validierung.
 * Bietet eine einheitliche Schnittstelle zum Abfragen und Validieren von DOM-Elementen.
 * 
 * Funktionen:
 * - validateElement() - Überprüft, ob ein DOM-Element existiert
 * - getValidatedElement() - Selektiert und validiert ein DOM-Element
 * - getValidatedElements() - Selektiert und validiert mehrere DOM-Elemente
 */
